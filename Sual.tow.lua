...
--Visual
local Visuals = Tabs.Visual:AddSection("Visual")
...
Visuals:AddButton({
        Title = "Jump",
        Description = "Jump Add.",
        Callback = function()
            loadstring(game:HttpGet("https://raw.githubusercontent.com/SualYoru/SualHub/refs/heads/main/JumpInfiniti.lua", true))()
        end
    })
